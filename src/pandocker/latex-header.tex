...
\hypersetup{
  pdftitle={OWASP Smart Contract Security Testing Guide},
  pdfauthor={Shashank, Pratik Lagaskar and Nehal Pillai},
  pdfsubject={The Smart Contract Security Testing Guide (SCSTG) is a guide for DeFi developers and auditors.},
  pdfkeywords={Smart Contract Security,solidity,EVM,OWASP}
}
